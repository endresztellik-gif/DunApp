...
export const GroundwaterTimestampTable: React.FC<GroundwaterTimestampTableProps> = ({
  ...
  if (visibleTimestamps.length === 0) {
    return (
      ...
      >
        <Clock className="mx-auto mb-3 h-12 w-12" style={{ color: 'var(--text-tertiary)' }} />
        <p style={{ color: 'var(--text-secondary)' }}>Jelenleg nincs elérhető talajvízkút adat.</p>
      </div>
    );
  }
  ...
  return (
    <div className="mt-6">
              ...
              return (
                ...
                >
                  ...
                  <td
                    ...
                    style={{ color: 'var(--color-dun-amber-400)', fontFamily: 'var(--font-data)' }}
                  >
                    #{timestamp.wellCode}
                  </td>
                  <td
          ...
          return (
            <div
              ...
              onKeyDown={
                onWellSelect
                  ? (e) => {
                      if (e.key === 'Enter' || e.key === ' ') onWellSelect(timestamp.wellId);
                    }
                  : undefined
              }
            >
      ...
      <div className="mt-3 text-xs italic" style={{ color: 'var(--text-tertiary)' }}>
        Az adatok 5 naponta automatikusan frissülnek. Egyes kutak adatai elavultak lehetnek a
        vizugy.hu adatforrás korlátozásai miatt.
      </div>
    </div>
  );
};
