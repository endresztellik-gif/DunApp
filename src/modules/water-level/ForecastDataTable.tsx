...
export const ForecastDataTable: React.FC<ForecastDataTableProps> = ({ stations }) => {
  ...
  const forecastDates = baseForecasts.map((f) => ({
  ...
  const renderCell = (cell: ForecastCell | null) =>
    cell ? (
      <div className="flex flex-col">
        ...
        {cell.hasUncertainty && (
          <span className="mt-0.5 text-xs" style={{ color: 'var(--text-tertiary)' }}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div
                        ...
                        style={{ background: dotColor(stationIndex) }}
                      ></div>
                      <span
                        className="text-sm font-semibold"
          ...
          return (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                {forecastDates.map((fd, index) => (
                  <div key={fd.dateString} className="flex items-center justify-between">
                    <span className="text-xs" style={{ color: 'var(--text-secondary)' }}>
                      {columnLabel(index, fd.date)}
                    </span>
