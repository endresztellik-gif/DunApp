...
export const SvgSprite = () => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }} aria-hidden="true">
    ...
    <symbol id="icon-meteo" viewBox="0 0 24 24">
      ...
      />
      <path
        d="M7 18 Q7 14.5 10.5 14.5 Q10 12 13 12.8 Q14.5 10.5 17 12 Q20 11.5 20 14.5 Q22 14.5 22 17 Q22 20 19 20 H10 Q7 20 7 18Z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.4"
    ...
    <symbol id="icon-water" viewBox="0 0 24 24">
      ...
      <path
        d="M7 13.5 Q9 12 11 13.5 Q13 15 15 13.5 Q16.5 12.5 17 13.5"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
    ...
    <symbol id="icon-water-down" viewBox="0 0 24 24">
      ...
      <path
        d="M7 15 Q9 13.5 11 15 Q13 16.5 15 15 Q16.5 14 17 15"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
    ...
    <symbol id="icon-drought-severe" viewBox="0 0 24 24">
      ...
      />
      <path
        d="M4 15.5 L5.5 19 L8 17 L9.5 22"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    <symbol id="icon-groundwater" viewBox="0 0 24 24">
      ...
      />
      <path
        d="M12 16.5 Q10.5 18 10.5 19.2 Q10.5 21 12 21 Q13.5 21 13.5 19.2 Q13.5 18 12 16.5Z"
        fill="currentColor"
        opacity={0.45}
      />
      <line
    ...
    <symbol id="icon-alert-bell" viewBox="0 0 24 24">
      <path
        d="M12 3 Q8 3 7 7 L6 15 Q5 16 4 17 H20 Q19 16 18 15 L17 7 Q16 3 12 3Z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <path
        d="M9 17 Q9.5 15.5 11 17 Q12 18.2 13 17 Q14.5 15.5 15 17"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
    ...
    <symbol id="icon-station" viewBox="0 0 24 24">
      <path
        d="M12 2 C8.5 2 6 5 6 8 C6 12.5 12 20 12 20 C12 20 18 12.5 18 8 C18 5 15.5 2 12 2Z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.5"
      />
      ...
      <path
        d="M5 17 Q8.5 15 12 17 Q15.5 19 19 17"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
      ...
      />
      <path
        d="M3 20 Q7.5 17.5 12 20 Q16.5 22.5 21 20"
        fill="none"
        stroke="currentColor"
        strokeWidth="1"
        strokeLinecap="round"
    ...
    <symbol id="icon-chart" viewBox="0 0 24 24">
      ...
      />
      <polyline
        points="4,16 7,12 10,14 13,8 17,10 21,6"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
