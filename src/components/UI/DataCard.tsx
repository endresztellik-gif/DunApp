...
export const DataCard = React.memo<DataCardProps>(
  ({
    ...
    return (
      <div className={`dun-card ${className}`} role="region" aria-labelledby={`card-${label}`}>
        {/* Header */}
        <div className="dun-card-header">
          <IconComponent size={20} aria-hidden style={{ color: accentColor, flexShrink: 0 }} />
          <span
            id={`card-${label}`}
        ...
        <div className="dun-card-body">
          ...
          <div className="mt-auto">
            <p className="dun-value" style={{ color: 'var(--text-primary)' }} aria-live="polite">
              {displayValue}
